...
terah.children.carter = carter = { name: "Carter"}
terah.children.colton = colton = { name: "Colton"}
...
// The most challenging exercise: understanding the syntax for building nested objects. It's deceptively simple, so much so that it's a bit confusing.


// How difficult was it to add and delete properties outside of the object itself? What did you learn about manipulating objects in this challenge?
// Surprisingly easy! The delete function does exactly as it states.
// Likewise, adding values to an object resembles the process of adding keys and values to a Ruby hash.
// I learned the syntax for creating nested objects.
//
